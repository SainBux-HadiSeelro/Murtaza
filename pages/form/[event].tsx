...
const EVENT_CONFIG = {
  shadi: {
    ...
    emoji: '🌸',
    btnGradient: 'from-rose-600 to-pink-500',
    btnHover: 'hover:from-rose-500 hover:to-pink-400',
  },
};

export default function GuestForm({ event }: Props) {
  ...
  const handleSubmit = async (e: FormEvent) => {
    ...
    try {
      await addGuestEntry({ name, phone: '', message, photoFile: photo, event });
  ...
  if (formState === 'success') {
    return (
      <>
        <Head><title>Shukriya! — Shadi Function</title></Head>
        <div className="bg-wedding-form flex items-center justify-center p-6 min-h-screen">
          <div className="glass-card p-10 max-w-md w-full text-center animate-fade-in">
            ...
            <div className="text-4xl space-x-2">
              <span>💍</span><span>{cfg.emoji}</span><span>✨</span>
            </div>
          </div>
        </div>
      </>
  ...
  return (
    <>
      <Head>
        <title>Shadi Function — Guest Message</title>
        <meta name="viewport" content="width=device-width, initial-scale=1, maximum-scale=1" />
      </Head>

      <div className="bg-wedding-form flex items-center justify-center p-4 py-8">
        ...
        <div className="w-full max-w-md relative z-10">
          ...
          <div className="text-center mb-8">
            ...
            <div className="relative flex items-center justify-center mb-4">
              ...
              {/* Bride */}
              <div className="relative z-10 flex flex-col items-center" style={{ animation: 'float 4s ease-in-out infinite' }}>
            ...
            <p className="text-white/50 text-sm mt-2 italic" style={{ fontFamily: 'Playfair Display, serif' }}>
              "May Allah bless this union with love and barakah."
            </p>
          ...
          <div className="glass-card p-6 sm:p-8">
            ...
            <form onSubmit={handleSubmit} noValidate className="space-y-5">
              ...
              <button
                ...
                className={`btn-primary bg-gradient-to-r ${cfg.btnGradient} ${cfg.btnHover} mt-2`}
              >
...
export const getServerSideProps: GetServerSideProps = async ({ params }) => {
  ...
  if (event !== 'shadi') return { notFound: true };
  return { props: { event } };
};
